        ...
        <div className="flex-grow overflow-y-auto p-8 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button 
                onClick={handleCopy}
                className="flex items-center gap-2 text-[10px] font-black uppercase text-neutral-400 hover:text-white transition-all bg-white/5 hover:bg-white/10 px-4 py-2 rounded-sm border border-white/10 hover:border-white/30 active:scale-95 shadow-lg group"
              >
                {copied ? <Check size={14} className="text-emerald-500" /> : <Copy size={14} className="group-hover:neon-white" />}
